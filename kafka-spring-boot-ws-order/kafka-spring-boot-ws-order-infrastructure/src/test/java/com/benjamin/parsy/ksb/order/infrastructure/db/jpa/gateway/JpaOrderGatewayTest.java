...
import com.benjamin.parsy.ksb.order.infrastructure.IntegrationTest;
...
@SpringBootTest
class JpaOrderGatewayTest extends IntegrationTest {
    ...
    void findByUuid_UserExist_ReturnUser() {
        ...
        // When
        Order order = assertDoesNotThrow(() -> jpaOrderGateway.findById(orderUuid));
