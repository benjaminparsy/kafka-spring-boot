...
public class JsonHelper {
    ...
    public static <E, C extends Collection<E>> C toEntityCollection(String json, Class<E> entityClass, C collection) throws JsonProcessingException {
        CollectionType listType = OBJECT_MAPPER.getTypeFactory().constructCollectionType(collection.getClass(), entityClass);
